...
export function CategoryStat({ dashboard, fetchParams, setDashboards, render }) {
    ...
    const [countCalls, setCountCalls] = React.useState({outgoing: 0, incoming: 0, general: 0});
    ...
    return (
        <>
            ...
            {usedStatistics.MONEY ? (
                (categoriesList === '' || chosenCategories.length === 0) ? null : isDealsLoaded && render ? (
                    <MoneyStatistics
                        setError={setError}
